...
for i = 1:n
    ...
    acc_tar = test_svm(model_tar, labels.test.target, data.test.target, param);
    ...
    acc_src_ssvm = test_svm(model_src_ssvm, labels.test.target, data.test.target, param);
    ...
    acc_tar_ssvm = test_svm(model_tar_ssvm, labels.test.target, data.test.target, param);
    ...
    acc_pmt_svm = test_svm(model_pmt_svm, labels.test.target, data.test.target, param);
