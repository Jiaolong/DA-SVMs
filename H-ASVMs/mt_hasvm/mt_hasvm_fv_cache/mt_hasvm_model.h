...
struct model {
  ...
  /** ----------------------------------------------------------------
   ** Hierarchical Adaptive Model Parameters
   **/
  // Model id in the hierachical tree
  int m_id;
  // Parent model id
  int parent_id;
...
typedef vector<model> Moldes;
typedef Moldes::iterator model_iter;
#endif // MODEL_H
