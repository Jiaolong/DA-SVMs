function mt_hasvm_fv_compile(opt, verb)
...
mexcmd = [mexcmd ' mt_hasvm/mt_hasvm_fv_cache/mt_hasvm_fv_cache.cc mt_hasvm/mt_hasvm_fv_cache/mt_hasvm_obj_func.cc'];
...
try
  ...
  warning(e.identifier, 'Maybe you need to call mt_hasvm_fv_cache(''unlock'') first?');
end
