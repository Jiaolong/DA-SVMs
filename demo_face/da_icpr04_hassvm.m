...
t = 3;
data.train.targets{t}   = data.train.t3;
mid = get_model_id(target_domains(t), target_domains, param);
data.train.targets_model_ids{t}  = mid*ones(1,size(data.train.targets{t},1));
labels.train.targets{t} = labels.train.t3;

t = 4;
data.train.targets{t}   = data.train.t4;
mid = get_model_id(target_domains(t), target_domains, param);
data.train.targets_model_ids{t}  = mid*ones(1,size(data.train.targets{t},1));
labels.train.targets{t} = labels.train.t4;
