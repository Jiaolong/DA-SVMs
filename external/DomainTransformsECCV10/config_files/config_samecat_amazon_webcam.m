function PARAM = config_samecat_amazon_webcam(datadir)

PARAM.NUM_RUNS = 5;
PARAM.image_dirs = {'amazon/images/' 'webcam/images/'};
PARAM.domains = {'amazon/interest_points/' 'webcam/interest_points/' };
