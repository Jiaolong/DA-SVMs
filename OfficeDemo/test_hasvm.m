...
for i = 1:n
    ...
    for v=1:n_td
        ...
        accuracy_ssvm(i, test_domain_id) = test_svm(model_src_ssvm, labels.test.targets{test_domain_id}, data.test.targets{test_domain_id});
        ...
        [accuracy_hasvm(i, test_domain_id), pl] = test_svm(model_hasvm, labels.test.targets{test_domain_id}, data.test.targets{test_domain_id});
